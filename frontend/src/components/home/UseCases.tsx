      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold">
            Unlimited <span className="">Possibilities</span>
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-5 gap-8">
          {useCases.map((usecase, index) => {
            ...
            return (
              <div
                key={index}
                className="group border border-gray-200 p-4 rounded-xl space-y-2 bg-white transform transition-all duration-300 hover:-translate-y-1"
              >
                <div
